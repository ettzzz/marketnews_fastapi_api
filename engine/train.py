...
pretrain_model_path = "voidful/albert_chinese_base"
tokenizer = AutoTokenizer.from_pretrained(pretrain_model_path)

### step1. read from txt file and build text label mapping
train_texts = []
train_labels = []
test_texts = []
test_labels = []
...
for file_name in ["negative", "positive"]:
    ...
    for data in datasets:
        try:
            data_piece = data.split("<|>")  # weird why | looks skewed..
...
### step2. building trainable datasets
...
### step3. set training confis and train
